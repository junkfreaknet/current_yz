 ...
 */
package get_database_properties;
import java.sql.*;
 ...
 * @author noriyuki
 */
public class Get_database_properties {
    ...
    public static void main(String[] args) {
        ...
        try{
            String db_name="tes_haid";
            //String db_name="sugid";
            //String db_name="SION0300";
            
                Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                Connection con_to_sugid = DriverManager.getConnection("jdbc:sqlserver://192.168.0.3\\SQLEXPRESS:1433;database=" + db_name + ";user=noriyuki;password=Noriyuki");
                //Connection con_to_sugid = DriverManager.getConnection("jdbc:sqlserver://U03AH13D\\MQSQLSERVER:1433;database=" + db_name + ";user=haidlogon;password=haidlogon");
