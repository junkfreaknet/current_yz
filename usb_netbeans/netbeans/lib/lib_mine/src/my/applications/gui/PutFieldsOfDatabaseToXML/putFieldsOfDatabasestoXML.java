...
//import my.utilities.db.gui.*;
import my.constants.*;
import java.awt.Color;
import javax.swing.tree.TreeSelectionModel;
//import my.applications.gui.PutFieldsOfDatabaseToXML.*;
/**
 *
 * @author noriyuki
 */
public class putFieldsOfDatabasestoXML extends javax.swing.JFrame implements javax.swing.event.TreeSelectionListener{
//public class putFieldsOfDatabasestoXML extends javax.swing.JFrame {
    private javax.swing.JTree tree_of_source=null;
    private javax.swing.JTree tree_of_dist=null;
    ...
    private static final String CS_NAME_TREE_SORUCE="src";
    private static final String CS_NAME_TREE_DIST="dist";
    /** Creates new form ViewFieldsOfTables */
    public putFieldsOfDatabasestoXML() {
        initComponents();       
    }
    ...
    private void initComponents() {
        ...
        pane_source.setName("pane_source"); // NOI18N
        pane_main_tabbed.addTab("tables", pane_source);
        ...
        pane_dist.setName("pane_dist"); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(40, 40, 40)
                        .addComponent(pane_dist, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(71, 71, 71)
                                .addComponent(pane_dist, javax.swing.GroupLayout.PREFERRED_SIZE, 283, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(18, 18, 18)
    ...
    private void common_action_btn_add_clicked(){
        ...
        //this.tree_of_dist=my.gui.tree.listener.implementes.TreeOfDatabase.addNodeToTree(mutable_node_selected, tree_of_dist);
        this.tree_of_dist=implement.addNodeToTree(mutable_node_selected, tree_of_dist);
        if(this.tree_of_dist==null){
            if(is_debug){
                System.out.println("add action recieves null.");
            }
        }else{
            this.tree_of_dist.setName(this.CS_NAME_TREE_DIST);
            //this.tree_of_dist.addTreeSelectionListener(this);
            this.pane_dist.setViewportView(this.tree_of_dist);
        }
        
    }
    private void common_action_btn_delete_clicked(){
        //refresh only
        //my.gui.tree.listener.implementes.TreeOfDatabase.deleteNodeFromTree(this.pane_output, mutable_node_selected, tree_of_dist);
        implement.deleteNodeFromTree(this.pane_dist, this.mutable_node_selected, tree_of_dist);
        ...
        if(par_sqlserver==null){
            ...
            if(my.db.utilities.Utilities.isEnableServer(par_sqlserver)){
                if(my.db.utilities.UtilitiesGUI.isDatabaseAlreadyExistsOnTree(par_sqlserver, node_source_databases)){
                    ...
                    this.tree_of_source=my.db.utilities.UtilitiesGUI.createTreeOfDatabases(node_source_databases);
                    //this.tree_of_source.getSelectionModel().setSelectionMode(TreeSelectionModel.SINGLE_TREE_SELECTION);
                    if(this.tree_of_source==null){
                        label.setText("selected db have no tables.");
                        label.setForeground(Color.RED);
                        javax.swing.JOptionPane.showMessageDialog(this, label);
                    }else{
                        this.tree_of_source.setName(this.CS_NAME_TREE_SORUCE);
                        //this.tree_of_source.addTreeSelectionListener(this);                
                        this.pane_source.setViewportView(this.tree_of_source);
                    }            
                }        
            }else{
    ...
    public void valueChanged(javax.swing.event.TreeSelectionEvent e){
        ...
        //common actions of "source" and "target" trees
        ...
        if(is_debug){
            ...
            System.out.println("paths are "+e.getPaths().toString());
            System.out.println("new path is "+e.getNewLeadSelectionPath());
            System.out.println("old path is "+e.getOldLeadSelectionPath());
        ...
        if(((javax.swing.JTree)e.getSource()).getName().equals(this.CS_NAME_TREE_SORUCE)){
            //source tree
            this.common_action_valueChanged_in_source_tree();
            if(is_debug){
                System.out.println("select source tree ");
                System.out.println("root of source ");
            }
        }
        
        if(((javax.swing.JTree)e.getSource()).getName().equals(this.CS_NAME_TREE_DIST)){
            //traget tree
            this.common_action_valueChanged_in_dist_tree();
            if(is_debug){
    ...
    private void common_action_valueChanged_in_dist_tree(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(putFieldsOfDatabasestoXML.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new putFieldsOfDatabasestoXML().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JScrollPane pane_dist;
    private javax.swing.JTabbedPane pane_main_tabbed;
    private javax.swing.JScrollPane pane_source;
