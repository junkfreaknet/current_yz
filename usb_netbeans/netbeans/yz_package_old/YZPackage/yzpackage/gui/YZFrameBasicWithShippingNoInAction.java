 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class YZFrameBasicWithShippingNoInAction extends YZFrameBasicWithShippingNo{
	
	Component cmpFirst;
	
	public YZFrameBasicWithShippingNoInAction(){
		
		super();
		yzFrameBasicSetFirstItem();
	}
	public YZFrameBasicWithShippingNoInAction(String strTitle){
